...
(define-fun ax2 () Bool (forall ((v Node) (u Node) (w Node)) (=> (and (directed_neighbor (rtc_pregraph g) v u) (directed_neighbor (rtc_pregraph g) u w)) (directed_neighbor (rtc_pregraph g) v w) )))
(define-fun ax3 () Bool (forall ((v Node) (u Node)) (=> (and (directed_neighbor (rtc_pregraph g) v u) (directed_neighbor (rtc_pregraph g) u v)) (= u v))))
(define-fun ax4 () Bool (forall ((v Node) (u Node) (w Node)) (=> (and (directed_neighbor (rtc_pregraph g) v u) (directed_neighbor (rtc_pregraph g) v w)) (or (directed_neighbor (rtc_pregraph g) u w) (directed_neighbor (rtc_pregraph g) w u)  ))))
